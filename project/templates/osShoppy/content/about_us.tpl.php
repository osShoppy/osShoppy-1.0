<!-- banner_top //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'aboutus_top')) { ?>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><?php include(DIR_WS_LANGUAGES . $language . '/' . FILENAME_DEFINE_ABOUT_US); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
<!-- banner_bot //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'aboutus_bot')) { ?>
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
		      <tr>
        		<td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '2'); ?></td>
      		  </tr>
