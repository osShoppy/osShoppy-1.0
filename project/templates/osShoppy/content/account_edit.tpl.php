...
<?php } ?>
                  ...
                  <tr>
                    ...
                    <td class="main"><?php echo tep_draw_input_field('insertion', $account['customers_insertion']) . '&nbsp;' . (tep_not_null(ENTRY_INSERTION_NAME_TEXT) ? '<span class="inputRequirement">' . ENTRY_INSERTION_NAME_TEXT . '</span>': ''); ?></td>
                  </tr>
                  <tr>
...
<?php } ?>
			      ...
			      <tr>
                    ...
                    <td class="main"><?php echo tep_draw_input_field('confirm_email_address', $account['customers_email_address']) . '&nbsp;' . (tep_not_null(ENTRY_EMAIL_ADDRESS_TEXT) ? '<span class="inputRequirement">' . ENTRY_EMAIL_ADDRESS_TEXT . '</span>': ''); ?></td>
                  </tr>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT, '', 'SSL') . '">' . tep_image_button('button_back.png', IMAGE_BUTTON_BACK) . '</a>'; ?></td>
