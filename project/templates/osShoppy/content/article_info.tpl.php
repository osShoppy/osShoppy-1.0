...
<?php
    if ($reviews['count'] <= 0) {
?>
                <td class="main"><?php echo '<a href="' . tep_href_link(FILENAME_ARTICLE_REVIEWS_WRITE, tep_get_all_get_params()) . '">' . tep_image_button('button_write_review.png', IMAGE_BUTTON_WRITE_REVIEW) . '</a>'; ?></td>
                <td align="right"><script language="javascript"><!--
                 document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link('article_popup_print.php', 'aID=' .  (int)$_GET['articles_id'] . '&language_id=' . (int)$languages_id) . '\\\')">' . tep_image_button('button_print_article.png', IMAGE_PRINT_ARTICLE) . '</a>'; ?>');
                 //--></script>
                </td>
<?php
    } else {
?>
                <td class="main"><?php echo '<a href="' . tep_href_link(FILENAME_ARTICLE_REVIEWS_WRITE, tep_get_all_get_params()) . '">' . tep_image_button('button_write_review.png', IMAGE_BUTTON_WRITE_REVIEW) . '</a> '; ?>
                <td class="center"><?php echo '<a href="' . tep_href_link(FILENAME_ARTICLE_REVIEWS, tep_get_all_get_params()) . '">' . tep_image_button('button_reviews.png', IMAGE_BUTTON_REVIEW) . '</a> '; ?></td>
                <td align="right"><script language="javascript"><!--
                 document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link('article_popup_print.php', 'aID=' .  (int)$_GET['articles_id'] . '&language_id=' . (int)$languages_id) . '\\\')">' . tep_image_button('button_print_article.png', IMAGE_PRINT_ARTICLE) . '</a>'; ?>');
                 //--></script>
                </td>
