            ...
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td><?php
                    ...
                    if ($valid_product) {
                      echo '<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $HTTP_GET_VARS['products_id']) . '">' . tep_image_button('button_back.png', IMAGE_BUTTON_BACK) . '</a>';
                      } else if ($valid_article) {
                        echo '<a href="' . tep_href_link(FILENAME_ARTICLE_INFO, 'articles_id=' . $HTTP_GET_VARS['articles_id']) . '">' . tep_image_button('button_back.png', IMAGE_BUTTON_BACK) . '</a>';
                    }
                    /**** END ARTICLE MANAGER ****/
                       ?></td>
