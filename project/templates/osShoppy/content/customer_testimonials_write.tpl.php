...
<?php if (USE_POINTS_AND_REWARDS == 'true') { ?>
      <tr>
        <td class="main" align="center"><?php echo TEXT_TESTIMONIALS_POINTS; ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
<?php } ?>
      <tr>
        <td class="main" align="center"><?php echo TEXT_TESTIMONIALS_SIGNATURE; ?></td>
      </tr>
      <tr>
        <td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '10'); ?></td>
      </tr>
...
<?php
  ...
  if (tep_session_is_registered('customer_id')) {
    ...
    $testimonials_name = $account['customers_firstname'] . ' ' . $account['customers_insertion'] . ' ' . $account['customers_lastname'];
...
?>
      <tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="2">
          ...
          <tr>
            <td class="main"><?php echo TEXT_TESTIMONIALS_ALLOWED; ?></td>
          </tr>
		  <tr>
			<td><?php echo tep_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
...
?>
                  <tr>
                    <td valign="top" class="main"><?php echo TEXT_UPLOAD_TESTIMONIAL_IMAGE; ?><br>
              ...
              <tr class="infoBoxContents">
                <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  <tr>
                    ...
                    <td class="main" align="right" valign="middle"><?php echo tep_image_submit('button_send_testimonial.png', IMAGE_BUTTON_SUBMIT_TESTIMONIAL); ?></td>
					<td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
                  </tr>
                </table></td>
              </tr>
