<!-- banner_top //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'achistory_top')) { ?>
            ...
            <tr class="infoBoxContents">
              <td><table border="0" width="100%" cellspacing="2" cellpadding="4">
                <tr>
                  ...
                  <td class="main" width="20%"><?php echo '<a href="' . tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, (isset($HTTP_GET_VARS['page']) ? 'page=' . $HTTP_GET_VARS['page'] . '&' : '') . 'order_id=' . $history['orders_id'], 'SSL') . '">' . tep_image_button('button_small_view.png', IMAGE_BUTTON_SMALL_VIEW) . '</a>'; ?></td>
                </tr>
              </table></td>
            </tr>
          </table>
...
<!-- banner_bot //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'achistory_bot')) { ?>
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
		      <tr>
        		<td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '2'); ?></td>
      		  </tr>
