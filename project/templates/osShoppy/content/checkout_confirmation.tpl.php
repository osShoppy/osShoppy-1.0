<!-- banner_top //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'chconfirm_top')) { ?>
...
<?php if (USE_HEADING_IMAGE_ON_ALL_PAGES == 'true') { ?>
            <td class="pageHeading" align="right"><?php echo tep_image(DIR_WS_IMAGES . 'filepics/filepic_checkout_confirmation.png', HEADING_TITLE, HEADING_IMAGE_WIDTH, HEADING_IMAGE_HEIGHT); ?></td>
<?php } ?>
          </tr>
        </table></td>
      </tr>
...
?>
              ...
              <tr>
                <td class="main"><?php echo $giftwrap_message; ?></td>
              </tr>
<?php
  }
?>
...
<?php
  ...
  echo tep_image_submit('button_confirm_order.png', IMAGE_BUTTON_CONFIRM_ORDER) . "\n";
?>
            </td>
          </tr>
        </table></td>
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="25%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td width="50%"><?php echo tep_draw_separator('pixel_silver.gif', '100%', '1'); ?></td>
                <td><?php echo tep_image(DIR_WS_IMAGES . 'icons/checkout_bullet/checkout_bullet_3.png'); ?></td>
                <td width="50%"><?php echo tep_draw_separator('pixel_silver.gif', '100%', '1'); ?></td>
              </tr>
            </table></td>
            <td width="25%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
...
<!-- banner_bot //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'chconfirm_bot')) { ?>
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
		      <tr>
        		<td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '2'); ?></td>
      		  </tr>
