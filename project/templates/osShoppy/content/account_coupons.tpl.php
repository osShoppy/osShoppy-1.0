<!-- banner_top //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'shipping_top')) { ?>
...
<?php if (USE_LATEST_NEWS_ON_SHIPPING == 'true') { ?>
      <tr>
...
<?php } ?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><?php include(DIR_WS_LANGUAGES . $language . '/' . FILENAME_DEFINE_SHIPPING); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
<!-- banner_bot //-->
          <?php if ($banner = tep_banner_exists('dynamic', 'shipping_bot')) { ?>
			<table border="0" width="100%" cellspacing="0" cellpadding="0">
		      <tr>
        		<td><?php echo tep_draw_separator('pixel_trans.gif', '100%', '2'); ?></td>
      		  </tr>
