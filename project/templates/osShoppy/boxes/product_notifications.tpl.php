<?php /* product_notifications infobox template  */ 
if ((!strstr($_SERVER['PHP_SELF'],EX_PR_1))and(!strstr($_SERVER['PHP_SELF'],EX_PR_2))and(!strstr($_SERVER['PHP_SELF'],EX_PR_3))and(!strstr($_SERVER['PHP_SELF'],EX_PR_4))and(!strstr($_SERVER['PHP_SELF'],EX_PR_5))and(!strstr($_SERVER['PHP_SELF'],EX_PR_6))and(!strstr($_SERVER['PHP_SELF'],EX_PR_7))and(!strstr($_SERVER['PHP_SELF'],EX_PR_8))and(!strstr($_SERVER['PHP_SELF'],EX_PR_9))and(!strstr($_SERVER['PHP_SELF'],EX_PR_10))and(!strstr($_SERVER['PHP_SELF'],EX_PR_11))and(!strstr($_SERVER['PHP_SELF'],EX_PR_12))and(!strstr($_SERVER['PHP_SELF'],EX_PR_13))and(!strstr($_SERVER['PHP_SELF'],EX_PR_14))and(!strstr($_SERVER['PHP_SELF'],EX_PR_15))
and(!strstr($_SERVER['PHP_SELF'],EX_PR_16))and(!strstr($_SERVER['PHP_SELF'],EX_PR_17))and(!strstr($_SERVER['PHP_SELF'],EX_PR_18))and(!strstr($_SERVER['PHP_SELF'],EX_PR_19))and(!strstr($_SERVER['PHP_SELF'],EX_PR_20))and(!strstr($_SERVER['PHP_SELF'],EX_PR_21))and(!strstr($_SERVER['PHP_SELF'],EX_PR_22))and(!strstr($_SERVER['PHP_SELF'],EX_PR_23))and(!strstr($_SERVER['PHP_SELF'],EX_PR_24))and(!strstr($_SERVER['PHP_SELF'],EX_PR_25))and(!strstr($_SERVER['PHP_SELF'],EX_PR_26))and(!strstr($_SERVER['PHP_SELF'],EX_PR_27))and(!strstr($_SERVER['PHP_SELF'],EX_PR_28))and(!strstr($_SERVER['PHP_SELF'],EX_PR_29))and(!strstr($_SERVER['PHP_SELF'],EX_PR_30))
){ ?>
          <tr>
            <td>
              <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="14" class="infoBoxHeadingProductnotifications"><img src="images/infobox/<?php switch ($corner_top_left) { case 'square': echo 'corner_right_left.gif';	break; case 'square_1': echo 'corner_right_left_1.gif';	break; case 'square_2': echo 'corner_right_left_2.gif';	break; case 'square_3': echo 'corner_right_left_3.gif';	break; case 'square_4': echo 'corner_right_left_4.gif';	break; case 'rounded': echo 'corner_top_left.gif'; break; case 'rounded_1': echo 'corner_top_left_1.gif'; break; case 'rounded_2': echo 'corner_top_left_2.gif'; break; case 'rounded_3': echo 'corner_top_left_3.gif'; break; case 'rounded_4': echo 'corner_top_left_4.gif'; break; } ?>" border="0" alt="" width="11" height="14"></td>
                  <td width="100%" height="14" class="infoBoxHeadingProductnotifications"><?php echo $boxHeading; ?></td>
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBoxProductnotifications">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxContentsProductnotifications">
              <tr>
