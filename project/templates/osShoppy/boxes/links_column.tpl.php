<?php /* infobox_column template  */ ?>
            <td valign="top">
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBoxColumnLinks">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxColumnContentsLinks">
              <tr>
