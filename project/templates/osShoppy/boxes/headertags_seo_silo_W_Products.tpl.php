<?php /* headertags_seo_sil_W_Products infobox template  */ ?>
          <tr>
            <td>
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBoxHeadertagsseoW">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxContentsHeadertagsseoW">
              <tr>
