<?php /* onliners_column infobox template  */ ?>
            <td valign="top">
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBoxColumnOnliners">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxColumnContentsOnliners">
              <tr>
