<?php /* infobox_column template  */ ?>
            <td valign="top">
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBoxColumnCustomergroup">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxColumnContentsCustomergroup">
              <tr>
                <td><img src="templates/<?php echo DIR_WS_TEMPLATES_DEFAULT ?>/boxes/images/pixel_trans.gif" border="0" alt="" width="100%" height="1"></td>
              </tr>
              <tr>
                <td class="boxTextCustomergroup"<?php echo $boxContent_attributes; ?>><?php echo $boxContent; ?></td>
              </tr>
              <tr>
                <td><img src="templates/<?php echo DIR_WS_TEMPLATES_DEFAULT ?>/boxes/images/pixel_trans.gif" border="0" alt="" width="100%" height="1"></td>
              </tr>
