<?php /* manufacturerinfo infobox template  */ 
if ((!strstr($_SERVER['PHP_SELF'],EX_MAI_1))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_2))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_3))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_4))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_5))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_6))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_7))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_8))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_9))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_10))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_11))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_12))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_13))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_14))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_15))
and(!strstr($_SERVER['PHP_SELF'],EX_MAI_16))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_17))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_18))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_19))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_20))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_21))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_22))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_23))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_24))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_25))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_26))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_27))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_28))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_29))and(!strstr($_SERVER['PHP_SELF'],EX_MAI_30))
){ ?>
          <tr>
            <td>
              <table border="0" width="100%" cellspacing="0" cellpadding="0">
                <tr>
                  <td height="14" class="infoBoxHeadingManufacturerinfo"><img src="images/infobox/<?php switch ($corner_top_left) { case 'square': echo 'corner_right_left.gif';	break; case 'square_1': echo 'corner_right_left_1.gif';	break; case 'square_2': echo 'corner_right_left_2.gif';	break; case 'square_3': echo 'corner_right_left_3.gif';	break; case 'square_4': echo 'corner_right_left_4.gif';	break; case 'rounded': echo 'corner_top_left.gif'; break; case 'rounded_1': echo 'corner_top_left_1.gif'; break; case 'rounded_2': echo 'corner_top_left_2.gif'; break; case 'rounded_3': echo 'corner_top_left_3.gif'; break; case 'rounded_4': echo 'corner_top_left_4.gif'; break; } ?>" border="0" alt="" width="11" height="14"></td>
                  <td width="100%" height="14" class="infoBoxHeadingManufacturerinfo"><?php echo $boxHeading; ?></td>
              ...
              <table border="0" width="100%" cellspacing="0" cellpadding="1" class="infoBoxManufacturerinfo">
              <tr>
                <td><table border="0" width="100%" cellspacing="0" cellpadding="3" class="infoBoxContentsManufacturerinfo">
              <tr>
