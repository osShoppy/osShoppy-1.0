<?php //$Id: /catalog/ask_a_question.php (2610)
...
<!-- body_text //-->
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="smallText"><br /><font color="#696969"><b><i><?php echo sprintf(HEADING_TITLE, $product_info['products_name']); ?> - (<?php echo $product_info['products_model'] ?>)</i></b></font></td>
          ...
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                ...
                <td></td>
                <td align="right"><?php echo tep_image_submit('button_send.png', IMAGE_BUTTON_SEND); ?></td>
                <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
              </tr>
            </table></td>
          </tr>
