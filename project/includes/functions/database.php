<?php // catalog/includes/functions/database.php (osC)
...
// BOF QPBPP for SPPC
//original      $update_table_sql1 = "update " . TABLE_PRODUCTS_GROUP_PRICES.$customer_group_id ." ppt left join " . TABLE_PRODUCTS_GROUPS . " pg using(products_id) set ppt.products_price = pg.customers_group_price where ppt.products_id = pg.products_id and pg.customers_group_id ='" . $customer_group_id . "'";
      $update_table_sql1 = "update " . TABLE_PRODUCTS_GROUP_PRICES.$customer_group_id ." ppt left join " . TABLE_PRODUCTS_GROUPS . " pg using(products_id) set ppt.products_price = pg.customers_group_price where pg.customers_group_price != null and ppt.products_id = pg.products_id and pg.customers_group_id ='" . $customer_group_id . "'";
// EOF QPBPP for SPPC
