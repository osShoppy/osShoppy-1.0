<?php // catalog/includes/functions/general.php (osC)
...
// TABLES: address_format
  function tep_address_format($address_format_id, $address, $html, $boln, $eoln) {
    ...
    if (isset($address['firstname']) && tep_not_null($address['firstname'])) {
      ...
      $insertion = tep_output_string_protected($address['insertion']);
    ...
    $street_no = tep_output_string_protected($address['street_no']);
    $street_no_add = tep_output_string_protected($address['street_no_add']);
...
// Text Mode
    ...
    $statecomma = '';
    $streets = $street;
    if ($suburb != '') $streets = $street . ' ' . $street_no . $street_no_add . $cr . $suburb;
...
// TABLES: customers, address_book
  function tep_address_label($customers_id, $address_id = 1, $html = false, $boln = '', $eoln = "\n") {
    ...
    $address_query = tep_db_query("select entry_firstname as firstname, entry_insertion as insertion, entry_lastname as lastname, entry_company as company, entry_street_address as street_address, entry_street_no as street_no, entry_street_no_add as street_no_add, entry_suburb as suburb, entry_city as city, entry_postcode as postcode, entry_state as state, entry_zone_id as zone_id, entry_country_id as country_id from " . TABLE_ADDRESS_BOOK . " where customers_id = '" . (int)$customers_id . "' and address_book_id = '" . (int)$address_id . "'");
...
// Return a customer greeting box
  function tep_customer_greeting_box() {
    global $customer_id, $customer_first_name;

    if (tep_session_is_registered('customer_first_name') && tep_session_is_registered('customer_id')) {
      $greeting_string = sprintf(TEXT_GREETING_PERSONAL_BOX, tep_output_string_protected($customer_first_name));
    }
