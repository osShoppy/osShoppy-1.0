<?php //$Id: /catalog/includes/classes/payment.php (4228)
  ...
  class ProductsInCategory {
    ...
    function addProductsInCategory ($categories_id, $product_info) {
	  ...
	  $products_name_length_set = DYNAMENU_MAX_CHARACTERS; // change to the maximum menu product name length before trucating ************
