<?php //$Id: /catalog/includes/classes/order.php (osC)
  ...
  class order {
    ...
    function query($order_id) {
      ...
      $order_query = tep_db_query("select customers_id, customers_name, customers_company, customers_street_address, customers_street_no, customers_street_no_add, customers_suburb, customers_city, customers_postcode, customers_state, customers_country, customers_telephone, customers_email_address, customers_address_format_id, customers_dummy_account, delivery_name, delivery_company, delivery_street_address, delivery_street_no, delivery_street_no_add, delivery_suburb, delivery_city, delivery_postcode, delivery_state, delivery_country, delivery_address_format_id, billing_name, billing_company, billing_street_address, billing_street_no, billing_street_no_add, billing_suburb, billing_city, billing_postcode, billing_state, billing_country, billing_address_format_id, payment_method, cc_type, cc_owner, cc_number, cc_expires, giftMessage, currency, currency_value, date_purchased, orders_status, last_modified from " . TABLE_ORDERS . " where orders_id = '" . (int)$order_id . "'");
      ...
      $this->customer = array('id' => $order['customers_id'],
                              ...
                              'street_no' => $order['customers_street_no'],
                              'street_no_add' => $order['customers_street_no_add'],
...
// PWA EOF
      ...
      $this->delivery = array('name' => trim($order['delivery_name']),
                              ...
                              'street_no' => $order['delivery_street_no'],
                              'street_no_add' => $order['delivery_street_no_add'],
      ...
      $this->billing = array('name' => $order['billing_name'],
                             ...
                             'street_no' => $order['billing_street_no'],
                             'street_no_add' => $order['billing_street_no_add'],
    ...
    function cart() {
      ...
      global $customer_id, $sendto, $billto, $cart, $languages_id, $currency, $currencies, $shipping,$payment, $comments, $customer_default_address_id, $giftwrap_info, $giftwrap_message;
      ...
      $customer_address_query = tep_db_query("select c.customers_firstname, c.customers_insertion, c.customers_lastname, c.customers_telephone, c.customers_email_address, c.guest_account, ab.entry_company, ab.entry_street_address, ab.entry_street_no, ab.entry_street_no_add, ab.entry_suburb, ab.entry_postcode, ab.entry_city, ab.entry_zone_id, z.zone_name, co.countries_id, co.countries_name, co.countries_iso_code_2, co.countries_iso_code_3, co.address_format_id, ab.entry_state from " . TABLE_CUSTOMERS . " c, " . TABLE_ADDRESS_BOOK . " ab left join " . TABLE_ZONES . " z on (ab.entry_zone_id = z.zone_id) left join " . TABLE_COUNTRIES . " co on (ab.entry_country_id = co.countries_id) where c.customers_id = '" . (int)$customer_id . "' and ab.customers_id = '" . (int)$customer_id . "' and c.customers_default_address_id = ab.address_book_id");
      $customer_address = tep_db_fetch_array($customer_address_query);

      if (is_array($sendto) && !empty($sendto)) {
        $shipping_address = array('entry_firstname' => $sendto['firstname'],
                                  'entry_insertion' => $sendto['insertion'],
                                  'entry_lastname' => $sendto['lastname'],
                                  'entry_company' => $sendto['company'],
                                  'entry_street_address' => $sendto['street_address'],
                                  'entry_street_no' => $sendto['street_no'],
                                  'entry_street_no_add' => $sendto['street_no_add'],
        ...
        $shipping_address_query = tep_db_query("select ab.entry_firstname, ab.entry_insertion, ab.entry_lastname, ab.entry_company, ab.entry_street_address, ab.entry_street_no, ab.entry_street_no_add, ab.entry_suburb, ab.entry_postcode, ab.entry_city, ab.entry_zone_id, z.zone_name, ab.entry_country_id, c.countries_id, c.countries_name, c.countries_iso_code_2, c.countries_iso_code_3, c.address_format_id, ab.entry_state from " . TABLE_ADDRESS_BOOK . " ab left join " . TABLE_ZONES . " z on (ab.entry_zone_id = z.zone_id) left join " . TABLE_COUNTRIES . " c on (ab.entry_country_id = c.countries_id) where ab.customers_id = '" . (int)$customer_id . "' and ab.address_book_id = '" . (int)$sendto . "'");
        $shipping_address = tep_db_fetch_array($shipping_address_query);
      } else {
        $shipping_address = array('entry_firstname' => null,
                                  'entry_insertion' => null,
                                  'entry_lastname' => null,
                                  'entry_company' => null,
                                  'entry_street_address' => null,
                                  'entry_street_no' => null,
                                  'entry_street_no_add' => null,
                                  'entry_suburb' => null,
                                  'entry_postcode' => null,
                                  'entry_city' => null,
                                  'entry_zone_id' => null,
      ...
      if (is_array($billto) && !empty($billto)) {
        $billing_address = array('entry_firstname' => $billto['firstname'],
                                 'entry_insertion' => $billto['insertion'],
                                 'entry_lastname' => $billto['lastname'],
                                 'entry_company' => $billto['company'],
                                 'entry_street_address' => $billto['street_address'],
                                 'entry_street_no' => $billto['street_no'],
                                 'entry_street_no_add' => $billto['street_no_add'],
      ...
      $this->customer = array('firstname' => $customer_address['customers_firstname'],
                              'insertion' => $customer_address['customers_insertion'],
                              'lastname' => $customer_address['customers_lastname'],
                              'company' => $customer_address['entry_company'],
                              'street_address' => $customer_address['entry_street_address'],
                              'street_no' => $customer_address['entry_street_no'],
                              'street_no_add' => $customer_address['entry_street_no_add'],
...
// PWA EOF 2b
      ...
      $this->delivery = array('firstname' => $shipping_address['entry_firstname'],
                              'insertion' => $shipping_address['entry_insertion'],
                              'lastname' => $shipping_address['entry_lastname'],
                              'company' => $shipping_address['entry_company'],
                              'street_address' => $shipping_address['entry_street_address'],
                              'street_no' => $shipping_address['entry_street_no'],
                              'street_no_add' => $shipping_address['entry_street_no_add'],
      ...
      $this->billing = array('firstname' => $billing_address['entry_firstname'],
                             'insertion' => $billing_address['entry_insertion'],
                             'lastname' => $billing_address['entry_lastname'],
                             'company' => $billing_address['entry_company'],
                             'street_address' => $billing_address['entry_street_address'],
                             'street_no' => $billing_address['entry_street_no'],
                             'street_no_add' => $billing_address['entry_street_no_add'],
      ...
      for ($i=0, $n=sizeof($products); $i<$n; $i++) {
        ...
        if ($products[$i]['attributes']) {
          ...
          while (list($option, $value) = each($products[$i]['attributes'])) {
  			  // qtpro added: popt.products_options_track_stock,
...
// EOF Separate Pricing Per Customer attribute_groups mod
            ...
            $this->products[$index]['attributes'][$subindex] = array('option' => $attributes['products_options_name'],
                                                                     ...
                                                                     'prefix' => $attributes['price_prefix'],
                                                                     'price' => $attributes['options_values_price'],
                                                                     'track_stock' => $attributes['products_options_track_stock']); // qtpro
