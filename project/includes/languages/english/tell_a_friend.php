<?php
//$Id: /catalog/includes/languages/english/tell_a_friend.php
...
define('TEXT_EMAIL_LINK_FAQ', 'To view the FAQ click on the link below or copy and paste the link into your web browser:' . "\n\n" . '%s');
define('TEXT_EMAIL_LINK_G_INFO', 'To view the General Information click on the link below or copy and paste the link into your web browser:' . "\n\n" . '%s');
