<?php //$Id: /catalog/includes/languages/english/modules/order_total/ot_coupon.php

  define('MODULE_ORDER_TOTAL_COUPON_TITLE', '<img src="images/icons/arrows/ico_arrow.gif" title="Discount Coupon"> Used coupon code (<font color="green">');
...
// define('ERROR_REDEEMED_AMOUNT_ZERO', 'a valid coupon number. HOWEVER: No reduction will be applied, please see the coupon restrictions that was sent within your offer email**');
  ...
  define('TEXT_REDEEM_CODE', 'in here!');  
  define('TEXT_GREATER', 'on orders greater than ');  
