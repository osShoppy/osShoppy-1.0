<?php
//$Id: /catalog/includes/languages/english/links_submit.php
...
define('NAVBAR_TITLE_1', 'Submit A Link');
...
<p class="main">Welcome to our Link Exchange program. If you would like to exchange links with us, 
please copy "Our Website Information" below and use it to insert a link on your website. Once 
our link has been inserted on your website, please fill in the information requested under 
"Your Website Information" shown below, including the section "Reciprocal Page Details", where
you will fill in the URL of your links page that lists the link to our website.  Submit the request 
and you should get a response within 48 hours.</p>

<p class="main"><b>Please note:</b> You must have placed our link on your website BEFORE submitting 
your link to our website. Our policy is to verify our links on a regular basis and we will remove 
your link if we determine our link is not on your website.
</p>
');
...
<tr><td  class="main" height="40" valign="bottom"><b>Or copy the actual code below.</b></td></tr>
<tr>
 <td><table class="linkSubmit" border="0" width="100%" cellpadding="0">
  <tr class="infoBoxContents">
');
...
define('TEXT_LINKS_HELP', '<b>Site Title:</b> A descriptive title for your website.<br><br>
<b>URL:</b> The absolute web address of your website, including the \'http://\'.<br><br>
<b>Category:</b> Most appropriate category under which your website falls.<br><br>
<b>Suggest a Category:</b> Offer a suggestion for a link category if you cannot find one that suits your site.<br><br>
<b>Description:</b> A brief description of your website.<br><br>
<b>Image:</b> If you would like an image displayed with your link, upload it with this option<br><br>
<b>Full Name:</b> Your full name.<br><br>
<b>Email:</b> Your email address. Please enter a valid email, as you will be notified via email.<br><br>
<b>Reciprocal Page:</b> The absolute URL of your links page, where a link to our website will be listed/displayed.<br>Eg: http://your-domain.com/path/to/your/links_page.php');
...
define('ENTRY_LINKS_URL', 'Home Page URL:');
define('ENTRY_LINKS_URL_ERROR', 'URL must contain a minimum of ' . ENTRY_LINKS_URL_MIN_LENGTH . ' characters.');
define('ENTRY_LINKS_URL_NOT_FOUND_ERROR', 'URL could not be found => %s');
...
define('ENTRY_LINKS_UPLOAD_IMAGE', 'Image:');
...
define('ENTRY_LINKS_RECIPROCAL_URL', 'Reciprocal Page URL:');
...
define('ENTRY_LINKS_URL_MISMATCH_MAIN_IMAGE_ERROR', 'The main domain name, %s, has to match the image domain name, %s.');
define('ENTRY_LINKS_URL_MISMATCH_MAIN_PARENT_ERROR', 'A link to our link location, %s, cannot be found on the home page, %s.');
define('ENTRY_LINKS_URL_MISMATCH_MAIN_RECIPROCAL_ERROR', 'The domain name for the reciprocal link, %s, has to match the main domain name, %s.');
define('ENTRY_LINKS_URL_MISMATCH_RECIPROCAL_IMAGE_ERROR', 'The domain name for the reciprocal link, %s, has to match the image domain name, %s.');
define('ENTRY_LINKS_USERNAME', 'Username: ');
define('ENTRY_LINKS_PASSWORD', 'Password: ');

define('ERROR_FAILED_IMAGE_TYPE', 'Invalid file type for image');
define('ERROR_FAILED_IMAGE_UPLOAD', 'Failed to load image.');
