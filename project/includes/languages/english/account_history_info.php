<?php
//$Id: /catalog/includes/languages/english/account_history_info.php
...
define('TEXT_RETURN_PRODUCT','<br />Click to return this product?');
...
define('HEADING_GIFTWRAP_METHOD', 'Gift Card Method');
define('GIFT_CARD_MESSAGE', 'Message on Gift Card');
?>