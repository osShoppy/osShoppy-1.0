<?php
define('UHE_GREET', 'Hallo %s!');
define('UHE_SUBJECT', 'Een kennis wilt u een product van ' . STORE_NAME .' aanbevelen!');
define('UHE_INTRO', 'Jouw vriend %s dacht dat je hier misschien wel geinteresseerd in bent! <br>Het is een %s van %s.');
define('UHE_LINK', 'Om het product te bekijken gebruik dan de link hieronder of kopieer en plak de link in je webbrowser en druk op enter:');
define('UHE_SIGNATURE', '<i><b>Met vriendelijke groeten,</b>,<br />%s (%s)</i>');
define('UHE_TEXT_COMMENTS', '%s heeft het volgende bericht aan jou geschreven:');
