<?php
define('UHE_TEXT_DEAR', 'Beste');        
define('UHE_MESSAGE_GREETING', 'uw bestelling is aangepast door &eacute;&eacute;n van onze administrators. Dit kan in opdracht van u zijn geweest of doordat de bestelling niet volledig was.<br>Neem contact op met ' .STORE_OWNER_EMAIL_ADDRESS. ' mocht u nog vragen hebben over uw bestelling.<br><br>Hieronder vind u de nieuwe details van uw bestelling.'); 

define('UHE_TEXT_ORDER_NUMBER', 'Bestelnummer:');
define('UHE_TEXT_INVOICE_URL', 'Besteloverzicht:');
define('UHE_TEXT_DATE_ORDERED', 'Datum Aangepast:');
define('UHE_TEXT_COMMENTS', 'Uw commentaar bij de bestelling:');

define('UHE_TEXT_ORDER_CONTENTS', 'Inhoud van de bestelling');
define('UHE_TEXT_PRODUCTS_ARTICLE', 'Product');
define('UHE_TEXT_PRODUCTS_MODEL', 'Model');
define('UHE_TEXT_PRODUCTS_PRICE', 'Prijs&nbsp;(incl.&nbsp;btw)');
define('UHE_TEXT_PRODUCTS_QTY', 'Aantal');
define('UHE_TEXT_PRODUCTS_TOTAL', 'Totaal&nbsp;(incl.&nbsp;btw)');

define('UHE_TEXT_PAYMENT_METHOD', 'Betaal Methode');

define('UHE_TEXT_BILLING_ADDRESS', 'Factuur Adres');
define('UHE_TEXT_DELIVERY_ADDRESS', 'Verzend Adres');
