...
// BoF - Contribution Category Box Enhancement 1.1
    ...
    if (tep_has_category_subcategories($counter)) {
      $categories_string .= tep_image(DIR_WS_IMAGES . 'infobox/categories/pointer_blue.gif', '');
    }
    else {
      $categories_string .= tep_image(DIR_WS_IMAGES . 'infobox/categories/pointer_blue_light.gif', '');
    }
