...
$boxHeading = BOX_HEADING_GALLERY;
  ...
  $box_base_name = 'gallery_slideshow_column';
  $boxLinkGallery = '<a href="' . tep_href_link(FILENAME_GALLERY) . '"><img src="images/infobox/arrow_right.gif" border="0" alt="more" title="more" width="12" height="10"></a>';
