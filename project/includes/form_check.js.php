<?php //$Id: /catalog/includes/form_check.js.php (osC) ?>
...
?>
  ...
  check_select("source", "", "<?php echo ENTRY_SOURCE_ERROR; ?>");
  check_input("source_other", "", "<?php echo ENTRY_SOURCE_OTHER_ERROR; ?>");
