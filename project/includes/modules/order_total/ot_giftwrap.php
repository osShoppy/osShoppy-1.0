<?php // catalog/includes/modules/order_total/ot_giftwrap.php (1155)
  ...
  class ot_giftwrap {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ORDER_TOTAL_GIFTWRAP_SORT_ORDER', '4', 'Sort order of display.', '6', '2', now())");
