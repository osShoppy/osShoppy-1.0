<?php // catalog/includes/modules/order_total/ot_total.php (osC)
  ...
  class ot_total {
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_ORDER_TOTAL_TOTAL_SORT_ORDER', '14', 'Sort order of display.', '6', '2', now())");
    }
