<?php
require(DIR_FS_CATALOG . DIR_WS_LANGUAGES . $language . '/modules/html_mail/basic/create_account_admin.php');
...
$HTMLMailMainContent = str_replace($ArrayLNTargets, '<br />', UHE_WELCOME . UHE_TEXT . UHE_EMAIL_PASS . $password . UHE_TEXT_1 . UHE_TEXT_2 . UHE_WARNING);
