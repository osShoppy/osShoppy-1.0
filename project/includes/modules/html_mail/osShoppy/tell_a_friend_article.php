...
require(DIR_WS_LANGUAGES . $language . '/modules/html_mail/basic/tell_a_friend_article.php');
...
<td width="120" align="center"><a href="' . HTTP_SERVER . DIR_WS_CATALOG . 'customer_testimonials.php" style="text-decoration:none; color:black;"><span style="font-size: 12px;"><color="black" style="margin-left:0.3em; text-decoration:none; color:black;">'.LINK_TESTIMONIALS.'</font></a></td>
...
<table width="600" border="0" align="center" background="'. HTTP_SERVER . DIR_WS_CATALOG . DIR_WS_MODULES .'html_mail/'.HTML_EMAIL_LAYOUT.'/images/tell_a_friend/background_mid.png" cellpadding="0" cellspacing="0"><tr valign="middle">
		...
		<td>
			<table width="100%" border="0" align="center">
		  		<tr>
		    		<td><font face="Tahoma, Times New Roman, Times"><span style="font-size: 24px;">'. sprintf(UHE_GREET, $to_name) .'</span></span></font><p>'. sprintf(UHE_INTRO, $from_name, $article_info['articles_name'], STORE_NAME).'</p></td>
		  		</tr>
		  		<tr>
				...
				<a href="' . tep_href_link(FILENAME_ARTICLE_INFO, 'articles_id=' . $HTTP_GET_VARS['articles_id'], 'NONSSL', false) . '">' . tep_href_link(FILENAME_PRODUCT_INFO, 'articles_id=' . $HTTP_GET_VARS['articles_id'], 'NONSSL', false) . '</a><br />
				<br />
