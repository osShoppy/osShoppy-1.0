<?php // catalog/includes/modules/payment/moneyorder.php (osC)
...
// class constructor
    function moneyorder() {
      ...
      $this->email_footer = TEXT_MAIL_PAYABLE_TO . MODULE_PAYMENT_MONEYORDER_TEXT_EMAIL_FOOTER . TEXT_MAIL_IF_PAID;
    }
...
// class methods
    ...
    function confirmation() {
      return array('title' => TEXT_PAYABLE_TO . MODULE_PAYMENT_MONEYORDER_TEXT_DESCRIPTION . TEXT_IF_PAID);
    }
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added, use_function, set_function) values ('Make Payable to:', 'MODULE_PAYMENT_MONEYORDER_PAYTO', '', 'Who should payments be made payable to?', '6', '1', now(), NULL,'tep_cfg_textarea(');");
