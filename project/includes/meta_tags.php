<?php //$Id: /catalog/includes/meta_tags.php (5581)
// FILE: meta_tags.php
...
// END UPDATE
  ...
  define('META_TAG_TITLE', $mt_products_name . SECONDARY_SECTION . $mt_products_price . PRIMARY_SECTION . TITLE . $web_site_tagline);
