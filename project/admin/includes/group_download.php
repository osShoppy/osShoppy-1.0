<?php //$Id: /catalog/admin/includes/group_download.php (4868) ?>
      <tr>
...
<?php
      $per_page = MAX_ROW_LISTS_DOWNLOAD_GROUPS;
...
?>
                ...
                <td align="center" class="smallText">&nbsp;<?php echo tep_image_submit('button_update.png', IMAGE_UPDATE); ?>&nbsp;<?php echo '<a href="'.tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, '', 'NONSSL').'">'; ?><?php echo tep_image_button('button_cancel.png', IMAGE_CANCEL); ?></a>&nbsp;</td>
<?php
          echo '</form>' . "\n";
        } else {
?>
              ...
              <tr>
                <td colspan="2"><table border="0" width="100%" cellspacing="0" cellpadding="2">
                  ...
                  <tr class="attributes-odd">
                    ...
                    <td class="main" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_file_from_group&filegroup_id=' . $HTTP_GET_VARS['filegroup_id'] . '&group_file_id=' . $HTTP_GET_VARS['group_file_id'], 'NONSSL') . '">'; ?><?php echo tep_image_button('button_delete.png', ' delete '); ?></a>&nbsp;&nbsp;&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'option_page=' . $option_page . (isset($HTTP_GET_VARS['value_page']) ? '&value_page=' . $value_page : '') . (isset($HTTP_GET_VARS['attribute_page']) ? '&attribute_page=' . $attribute_page : '') . (isset($HTTP_GET_VARS['file_group_page']) ? '&file_group_page=' . $file_group_page : '') . (isset($HTTP_GET_VARS['group_file_page']) ? '&group_file_page=' . $group_file_page : ''), 'NONSSL') . '">'; ?><?php echo tep_image_button('button_cancel.png', ' cancel '); ?></a>&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="4"><?php echo tep_black_line(); ?></td>
                  </tr>
...
?>
                  ...
                  <tr class="<?php echo (floor($rows/2) == ($rows/2) ? 'attributes-even' : 'attributes-odd'); ?>">
                    ...
                    <td class="main" align="right"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_file_all_groups&group_file_id=' . $HTTP_GET_VARS['group_file_id'], 'NONSSL') . '">'; ?><?php echo tep_image_button('button_delete.png', ' delete '); ?></a>&nbsp;&nbsp;&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'option_page=' . $option_page . (isset($HTTP_GET_VARS['value_page']) ? '&value_page=' . $value_page : '') . (isset($HTTP_GET_VARS['attribute_page']) ? '&attribute_page=' . $attribute_page : '') . (isset($HTTP_GET_VARS['file_group_page']) ? '&file_group_page=' . $file_group_page : '') . (isset($HTTP_GET_VARS['group_file_page']) ? '&group_file_page=' . $group_file_page : ''), 'NONSSL') . '">'; ?><?php echo tep_image_button('button_cancel.png', ' cancel '); ?></a>&nbsp;</td>
                  </tr>
                  <tr>
                    <td colspan="4"><?php echo tep_black_line(); ?></td>
                  </tr>
...
<?php
        ...
        if ($num_rows > MAX_ROW_LISTS_DOWNLOAD_GROUPS) {
...
<?php
      ...
      if ($file_all_num > 0) {
        ...
        if ($file_num > 0) {
          ...
          if ($file_num > MAX_ROW_LISTS_DOWNLOAD_FILES) {
...
?>
              ...
              <tr>
                <td colspan="3" align="right"><?php echo  tep_image_submit('button_insert.png', IMAGE_INSERT); ?>&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'group_file_page=' . $group_file_page, 'NONSSL') . '">'; ?><?php echo tep_image_button('button_cancel.png', IMAGE_CANCEL); ?></a></td>
<?php
        }
      }
      if ($no_file_found) {
...
<?php
      $per_page = MAX_ROW_LISTS_DOWNLOAD_FILES;
...
?>
                <tr>
                  ...
                  <td align="right" class="smallText" width="190">&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=update_group_file&filegroup_id=' . $group_files_array['download_group_id'] . '&group_file_id=' . $group_files_array['download_groups_file_id'] . (isset($HTTP_GET_VARS['group_file_page']) ? '&group_file_page=' . $HTTP_GET_VARS['group_file_page'] : ''), 'NONSSL') . '">'; ?><?php echo tep_image_button('button_edit.png', IMAGE_UPDATE); ?></a>&nbsp;&nbsp;<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_ATTRIBUTES, 'action=delete_group_file&filegroup_id=' . $group_files_array['download_group_id'] . '&group_file_id=' . $group_files_array['download_groups_file_id'], 'NONSSL') , '">'; ?><?php echo tep_image_button('button_delete.png', IMAGE_DELETE); ?></a>&nbsp;</td>
                </tr>
<?php
        }
