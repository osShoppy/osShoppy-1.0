...
<?php
  ...
  switch ($HTTP_GET_VARS['action']) {
    ...
    case 'edit':
      ...
      $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_update.gif', IMAGE_UPDATE) . ' <a href="' . tep_href_link(FILENAME_REFUND_METHODS, 'page=' . $HTTP_GET_VARS['page'] . '&oID=' . $oInfo->refund_method_id) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
      break;
    case 'delete':
      ...
      if ($remove_status) $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.gif', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_REFUND_METHODS, 'page=' . $HTTP_GET_VARS['page'] . '&oID=' . $oInfo->refund_method_id) . '">' . tep_image_button('button_cancel.gif', IMAGE_CANCEL) . '</a>');
      break;
    default:
      if (is_object($oInfo)) {
        $heading[] = array('text' => '<b>' . $oInfo->refund_method_name . '</b>');

        $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_REFUND_METHODS, 'page=' . $HTTP_GET_VARS['page'] . '&oID=' . $oInfo->refund_method_id . '&action=edit') . '">' . tep_image_button('button_edit.gif', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(FILENAME_REFUND_METHODS, 'page=' . $HTTP_GET_VARS['page'] . '&oID=' . $oInfo->refund_method_id . '&action=delete') . '">' . tep_image_button('button_delete.gif', IMAGE_DELETE) . '</a>');
