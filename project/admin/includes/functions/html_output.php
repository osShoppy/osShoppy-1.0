<?php //$Id: /catalog/admin/includes/functions/html_output.php (osC) 
  ...
  function tep_image_button($image, $alt = '', $params = '') {
    global $language;
	 ...
	 if (ADMIN_BUTTON =="true"){
		  return tep_image(DIR_WS_ADMIN . 'templates/'. ADMIN_TEMPLATE.'/images/buttons/'. $language . '/' . $image, $alt, '', '', $params);
	 }else {
...
// Output a form input field
  function tep_draw_input_field($name, $value = '', $parameters = '', $required = false, $type = 'text', $reinsert_value = true) {
    ...
    if ($required == true) $field .= '<span class="fieldRequired">' . TEXT_FIELD_REQUIRED . '</span>';
