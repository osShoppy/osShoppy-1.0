<?php //$Id: /catalog/admin/includes/languages/english/general_information_reviews.php

define('HEADING_TITLE', 'INFO Article Reviews');

define('TABLE_HEADING_ARTICLES', 'INFO Articles');
define('TABLE_HEADING_RATING', 'Rating');
define('TABLE_HEADING_DATE_ADDED', 'INFO Date Added');
