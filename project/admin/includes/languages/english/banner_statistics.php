<?php //$Id: /catalog/admin/includes/languages/english/banner_statistics.php
...
define('TEXT_BANNERS_DAILY_STATISTICS', 'Daily Statistics For %s %s');
define('TEXT_BANNERS_MONTHLY_STATISTICS', '&nbsp;Monthly Statistics For %s %s&nbsp;');
define('TEXT_BANNERS_YEARLY_STATISTICS', '&nbsp;Yearly Statistics %s&nbsp;');
