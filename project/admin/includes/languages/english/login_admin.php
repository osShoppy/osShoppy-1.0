<?php //$Id: /catalog/admin/includes/languages/english/login_admin.php


define('NAVBAR_TITLE', 'Login');
define('HEADING_TITLE', 'Welcome, sign in at your '.STORE_NAME.' Admin Panel here!');
define('TEXT_STEP_BY_STEP', ''); // should be empty
define('CHOOSE_LANGUAGE', 'Choose Language ');
