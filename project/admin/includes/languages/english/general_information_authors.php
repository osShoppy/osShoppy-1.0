<?php //$Id: /catalog/admin/includes/languages/english/general_information_aythors.php

define('HEADING_TITLE', 'INFO Authors');

define('TABLE_HEADING_AUTHORS', 'INFO Authors');
