<?php //$Id: /catalog/admin/includes/languages/english/reviews.php
...
define('TEXT_INFO_REVIEW_TEXT', 'Review:<br>');
...
define('JS_REVIEW_TEXT', 'Attention: ');
define('JS_REVIEW_RATING', 'There need to be a star given.');
define('JS_REVIEW_ERROR_TEXT', ' Please enter the reviewers name.');
