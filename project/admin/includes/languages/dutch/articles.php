<?php //$Id: /catalog/admin/includes/languages/dutch/articles.php
...
define('TABLE_HEADING_TOPICS_ARTICLES', 'Categorie&euml;n / Artikels');
define('TABLE_HEADING_ACTION', 'Actie');
define('TABLE_HEADING_STATUS', 'Status');
define('TABLE_HEADING_SORT_ORDER', 'Volgorde');
...
define('TEXT_EDIT_ARTICLE', 'Bewerk Artikel');
...
define('TEXT_ARTICLES_BLOG_STATUS', 'Artikel Blog Status:');
define('TEXT_ARTICLE_BLOG_NO', 'nee');
define('TEXT_ARTICLE_BLOG_YES', 'ja');
