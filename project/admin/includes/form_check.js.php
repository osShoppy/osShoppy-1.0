<?php //$Id: /catalog/admin/includes/form_check.js.php (osC) ?>
...
?>
  ...
  var street_no = document.account_edit.street_no.value;
...
?>
  ...
  if (document.account_edit.elements['street_no'].type != "hidden") {
    if (street_no == '' || street_no.length < <?php echo ENTRY_STREET_NO_MIN_LENGTH; ?>) {
