<?php //catalog/admin/includes/modules/create_order_details.php (4829)
...
<?php } ?> 
		  ...
		  <tr>
            ...
            <td class="main">&nbsp;<?php echo tep_draw_input_field('customers_insertion', $account['customers_insertion']) . '&nbsp;' . ENTRY_INSERTION_NAME_TEXT; ?> </td>
          </tr>
          <tr>
