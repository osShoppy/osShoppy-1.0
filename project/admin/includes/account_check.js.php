<?php //$Id: /catalog/admin/includes/account_check.js.php (5388) 
...
function validateForm() {
  ...
  } else if (adminEmail.indexOf("@") <= 1 || adminEmail.indexOf("@") >= (adminEmail.length - 3) || adminEmail.indexOf(".", (adminEmail.length - 3)) >= (adminEmail.length - 2) || adminEmail.indexOf("@.") >= 0 ) {
