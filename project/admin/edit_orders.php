<?php //$Id: /catalog/admin/edit_orders.php (1435)
...
if (EMAIL_USE_HTML == 'true') {
	require(DIR_FS_CATALOG_MODULES . 'html_mail/'. HTML_EMAIL_LAYOUT .'/edit_orders.php');
...
if(HTML_EMAIL_DEVELOPMENT_MODE === 'true'){
	...
	$TheFileName = DIR_FS_CATALOG . 'Last_mail_from_edit_orders.php.htm';
 ...
 ?>
      ...
      <div id="header">
          ...
          <ul>
			 ...
			 <?php if (ORDER_EDITOR_USE_AJAX == 'true') { ?>
              ...
              document.write("<li><a href=\"javascript:newOrderEmail()\"><img src=\"templates/<?php echo ADMIN_TEMPLATE ?>/images/buttons/<?php echo $language; ?>/button_new_order_email.png\" border=\"0\" alt=\"<?php echo IMAGE_NEW_ORDER_EMAIL; ?>\" title=\"<?php echo IMAGE_NEW_ORDER_EMAIL; ?>\" ></a></li>");
	           //--></script>
			   <?php } ?>
				  
		    <li><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $_GET['oID'] . '&action=edit') . '">' . tep_image_button('button_details.png', IMAGE_EDIT) . '</a>'; ?></li>
		    <li><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS_INVOICE, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . tep_image_button('button_invoice.png', IMAGE_ORDERS_INVOICE) . '</a>'; ?></li>
		    <li><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS_PACKINGSLIP, 'oID=' . $_GET['oID']) . '" TARGET="_blank">' . tep_image_button('button_packingslip.png', IMAGE_ORDERS_PACKINGSLIP) . '</a>'; ?></li>
		    <li><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('action'))) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a> '; ?></li>
		  </ul>
	...
	<!-- Begin Update Block, only for non-ajax use -->
           ...
           <div class="updateBlock">
              ...
              <div class="update5" align="center"><?php echo tep_image_submit('button_update.png', IMAGE_UPDATE); ?></div>
          </div>
            ...
            <table border="0" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td valign="top" width="100%">
				  <br>
				    <div>
					  <a href="<?php echo tep_href_link(FILENAME_ORDERS_EDIT_ADD_PRODUCT, 'oID=' . $_GET['oID'] . '&step=1'); ?>" target="addProducts" onClick="openWindow('<?php echo tep_href_link(FILENAME_ORDERS_EDIT_ADD_PRODUCT, 'oID=' . $_GET['oID'] . '&step=1'); ?>','addProducts');return false"><?php echo tep_image_button('button_add_article.png', TEXT_ADD_NEW_PRODUCT); ?></a><input type="hidden" name="subaction" value="">
				    </div>
				  <br>
			    </td>
  ...
  <tr class="dataTableHeadingRow">
	...
	<script language="JavaScript" type="text/javascript">
     <!--
		 ...
		 document.write("<img src=\"templates/<?php echo ADMIN_TEMPLATE ?>/images/buttons/<?php echo $language; ?>/button_update.png\" value=\"<?php echo oe_html_no_quote(AJAX_SUBMIT_COMMENT); ?>\" onClick=\"javascript:getNewComment();\">");
		 document.write("</td>");
		 document.write("</tr>");
	 //-->
    </script>
