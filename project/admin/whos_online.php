<?php //$Id: /catalog/admin/whos_online.php (0824)
...
// Images used for status lights
  $status_active_cart = 'icons/whoisonline_icons/icon_status_cart.gif'; // replace word cart with green if you don't want the new icon.
  $status_active_cart_top = 'icons/whoisonline_icons/icon_status_cart_top.gif';
  $status_inactive_cart = 'icons/whoisonline_icons/icon_status_cart_red.gif';
  $status_active_nocart = 'icons/whoisonline_icons/icon_summary_customers.gif';
  $status_inactive_nocart = 'icons/whoisonline_icons/icon_summary_customers_red.gif';
  $status_active_bot = 'icons/status_icons/icon_status_green_border_light.gif';
  $status_inactive_bot = 'icons/status_icons/icon_status_red_border_light.gif';
