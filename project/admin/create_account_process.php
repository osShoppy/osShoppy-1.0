<?php //$Id: /catalog/admin/create_account_process.php (5388)
...
if (EMAIL_USE_HTML == 'true') {
	require(DIR_FS_CATALOG_MODULES . 'html_mail/'. HTML_EMAIL_LAYOUT .'/create_account_admin.php');
...
if(HTML_EMAIL_DEVELOPMENT_MODE === 'true'){
	...
	$TheFileName = DIR_FS_CATALOG . 'Last_mail_from_create_account_admin.php.htm';
