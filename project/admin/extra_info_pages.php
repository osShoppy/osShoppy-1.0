<?php //$Id: /catalog/admin/extra_info_pages.php (2021)
...
?>
 ...
 <tr>
            ...
            <td class="main"><?echo tep_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;'?><select name="page_type" size=1>
                                 ...
                                 <option value="5" <? if($page_type == 5) { echo 'selected="selected"'; } ?>>5 - Conditions</option>
                                 <option value="6" <? if($page_type == 6) { echo 'selected="selected"'; } ?>>6 - Payment </option>
...
?>
                ...
                <td class="dataTableContent"><?php echo '<a href="javascript:popupImageWindow(\'' . FILENAME_POPUP_IMAGE . '?page=' . $pages['pages_id'] . '\')">' . tep_image(DIR_WS_IMAGES . 'icons/file_icons/preview.gif', 'View Page') . '</a>&nbsp;' . $pages['pages_title']; ?></td>
                <td class="dataTableContent"><?php echo $pages['page_type']; ?></td>
                <td class="dataTableContent"><?php echo $pages['sort_order']; ?></td>
                <td class="dataTableContent" align="center">
<?php
      if ($pages['status'] == '1') {
        echo tep_image(DIR_WS_IMAGES . 'icons/status_icons/icon_status_green.gif', 'Active', 10, 10) . '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_PAGE_MANAGER, 'page=' . $_GET['page'] . '&bID=' . $pages['pages_id'] . '&action=setflag&flag=0') . '">' . tep_image(DIR_WS_IMAGES . 'icons/status_icons/icon_status_red_light.gif', 'Set Inactive', 10, 10) . '</a>';
      } else {
        echo '<a href="' . tep_href_link(FILENAME_PAGE_MANAGER, 'page=' . $_GET['page'] . '&bID=' . $pages['pages_id'] . '&action=setflag&flag=1') . '">' . tep_image(DIR_WS_IMAGES . 'icons/status_icons/icon_status_green_light.gif', 'Set Active', 10, 10) . '</a>&nbsp;&nbsp;' . tep_image(DIR_WS_IMAGES . 'icons/status_icons/icon_status_red.gif', 'Inactive', 10, 10);
      }
?></td>
