<?php //$Id: /catalog/admin/gv_mail.php (282)
...
?>
                <table border="0" width="100%" cellpadding="0" cellspacing="2">
                  <tr>
                    ...
                    <td align="right"><?php echo '<a href="' . tep_href_link(FILENAME_GV_MAIL) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a> ' . tep_image_submit('button_email_coupon.png', IMAGE_SEND_EMAIL); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
...
?>
             ...
             <tr>
              ...
              <tr>
                <td colspan="2" align="right"><?php echo tep_image_submit('button_email_coupon.png', IMAGE_SEND_EMAIL); ?></td>
              </tr>
            </table></td>
          </form></tr>
<?php
