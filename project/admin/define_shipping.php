      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr><?php echo tep_draw_form('lng', FILENAME_DEFINE_SHIPPING, '', 'get'); ?>
            <td class="pageHeading"><?php echo BOX_MODULES_DEFINE_SHIPPING; ?></td>
...
?>
          <tr><?php echo tep_draw_form('language', FILENAME_DEFINE_SHIPPING, 'lngdir=' . $HTTP_GET_VARS['lngdir'] . '&filename=' . $HTTP_GET_VARS['filename'] . '&action=save'); ?>
            <td><table border="0" cellspacing="0" cellpadding="2">
              ...
              <tr>
                <td class="main"><?php if (HTML_DEFINE_SHIPPING_WYSIWYG_DISABLE == 'Enable') {
// Line Changed - MOD: Ajustable Editor Window
                echo tep_draw_fckeditor('file_contents', HTML_DEFINE_SHIPPING_WYSIWYG_WIDTH, HTML_DEFINE_SHIPPING_WYSIWYG_HEIGHT, $file_contents, (($file_writeable) ? '' : 'readonly')) . '</td>';
              ...
              <tr>
                <td align="right"><?php if ($file_writeable) { echo tep_image_submit('button_save.png', IMAGE_SAVE) . '&nbsp;<a href="' . tep_href_link(FILENAME_DEFINE_SHIPPING, 'lngdir=' . $HTTP_GET_VARS['lngdir']) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>'; } else { echo '<a href="' . tep_href_link(FILENAME_DEFINE_SHIPPING, 'lngdir=' . $HTTP_GET_VARS['lngdir']) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a>'; } ?></td>
              </tr>
            </table></td>
          </form></tr>
<?php
...
?>
          ...
          <tr>
            <td><?php echo '<a href="' . tep_href_link(FILENAME_DEFINE_SHIPPING, 'lngdir=' . $HTTP_GET_VARS['lngdir']) . '">' . tep_image_button('button_back.png', IMAGE_BACK) . '</a>'; ?></td>
          </tr>
<?php
    }
  } else {
