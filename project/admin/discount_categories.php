...
//--></script>
      ...
      <tr>
        <td style="padding-top: 10px;" align="right" class="main"><?php echo tep_image_submit('button_update.png', IMAGE_UPDATE) . ' <a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('action','dcID'))) .'">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>'; ?></td>
      </tr>
      </form>
...
<tr class="formArea" align="center">
  ...
  echo discount_categories_list(); ?></form></td>
    ...
    <tr class="formArea"><td colspan="5" style="border-left: 1px solid #7b9ebd; border-right: 1px solid #7b9ebd; border-bottom: 1px solid #7b9ebd"><?php echo tep_draw_separator('pixel_trans.gif', '1', '5'); ?></td></tr>
       </table>
     </td>
   </tr>
      ...
      <tr>
        ...
        <table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr class="dataTableHeadingRow">
            <td class="dataTableHeadingContent"><a href="<?php echo tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('sort_by','do')) . 'sort_by=pid'); ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_up.png', SORT_BY_PRODUCTS_ID_ASC); ?></a>&nbsp;<a href="<?php echo tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('sort_by','do')) . 'sort_by=pid-desc'); ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_down.png', SORT_BY_PRODUCTS_ID_DESC); ?></a>&nbsp;<?php echo TABLE_HEADING_PRODUCTS_ID; ?></td>
            <td class="dataTableHeadingContent"><a href="<?php echo tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('sort_by','do')) . 'sort_by=model'); ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_up.png', SORT_BY_PRODUCTS_MODEL_ASC); ?></a>&nbsp;<a href="<?php echo tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('sort_by')) . 'sort_by=model-desc'); ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_down.png', SORT_BY_PRODUCTS_MODEL_DESC); ?></a>&nbsp;<?php echo TABLE_HEADING_MODEL; ?></td>
            <td class="dataTableHeadingContent"><a href="<?php echo tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('sort_by','do')) . 'sort_by=name'); ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_up.png', SORT_BY_PRODUCTS_NAME_ASC); ?></a>&nbsp;<a href="<?php echo tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('sort_by','do')) . 'sort_by=name-desc'); ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_down.png', SORT_BY_PRODUCTS_NAME_DESC); ?></a>&nbsp;<?php echo TABLE_HEADING_NAME; ?></td>
            <td class="dataTableHeadingContent" align="center" valign="middle"><?php echo TABLE_HEADING_STATUS; ?></td>
            <td class="dataTableHeadingContent" valign="middle"><?php echo TABLE_HEADING_DISCOUNT_CATEGORY; ?></td>
...
<?php 
 while ($products = tep_db_fetch_array($products_query)) {
   ...
   echo '         <td class="dataTableContent">' . discount_categories_drop_down($get_discount_categories, $products['discount_categories_id'], $products['products_id']) . '</td>' . "\n";
	 echo '         <td class="dataTableContent" align="right"><a href="javascript:void(0)" onmouseover="window.status=\'' . TEXT_MOUSE_OVER_DISCOUNT_GROUPS_PER_GROUP_POPUP . '\';return true;" onmouseout="window.status=\'\'; return true;" onclick="window.open(\'' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES_GROUPS_PP, 'pID=' . $products['products_id'], 'NONSSL') . '\',\'' . NAME_WINDOW_DISCOUNT_GROUPS_PER_GROUP_POPUP . '\',\'menubar=yes,resizable=yes,scrollbars=yes,status=no,location=no,width=500,height=350\');return false">' . tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_popup.gif', TEXT_IMAGE_EDIT_GROUP_DISCOUNT_CATEGORIES) . '</a>' . tep_draw_separator('pixel_trans.gif', 16, 16) .'<a href="' . tep_href_link(FILENAME_CATEGORIES, 'cPath=' . $cPath . '&pID=' . $products['products_id'] . '&action=new_product') . '">' . tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_arrow_right.gif', TEXT_IMAGE_SWITCH_EDIT) . '</a></td>' . "\n";
   echo '        </tr>' . "\n";
...
// display bottom page buttons
              ...
              echo '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('action','do','x','y')) . 'action=show_products') . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>';
?></td>
      </tr>
        </table>
       </form></td>
...
?>
	  ...
	  <tr>
      <td style="padding-top: 20px;" class="smallText"><a href="<?php echo tep_href_link(FILENAME_DISCOUNT_CATEGORIES) . '">';
        echo TEXT_BACK_TO_DISCOUNT_CATEGORIES; ?></a></td>
     </tr>     
<?php     
	    ...
	    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
               <tr class="dataTableHeadingRow">
	       <td class="dataTableHeadingContent" width="10%"><a href="<?php echo basename($_SERVER['PHP_SELF']) . '?listing=id'; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_up.png', SORT_BY_ID_ASC); ?></a>&nbsp;<a href="<?php echo basename($_SERVER['PHP_SELF']) . '?listing=id-desc'; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_down.png', SORT_BY_ID_DESC); ?></a>&nbsp;<?php echo TABLE_HEADING_ID; ?></td>
	       <td class="dataTableHeadingContent"><a href="<?php echo basename($_SERVER['PHP_SELF']) . '?listing=dc'; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_up.png', SORT_BY_NAME_ASC); ?></a>&nbsp;<a href="<?php echo basename($_SERVER['PHP_SELF']) . '?listing=dc-desc'; ?>"><?php echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_down.png', SORT_BY_NAME_DESC); ?></a>&nbsp;<?php echo TABLE_HEADING_NAME; ?></td>
				   <td class="dataTableHeadingContent" align="right" valign="middle"><?php echo TABLE_HEADING_ACTION; ?>&nbsp;</td>
			   </tr>
...
?>
                ...
                <td class="dataTableContent" align="right"><?php if ( (is_object($cInfo)) && ($discount_categories['discount_categories_id'] == $cInfo->discount_categories_id) ) { echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_arrow_right.gif', ''); } else { echo '<a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('dcID')) . 'dcID=' . $discount_categories['discount_categories_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_info.gif', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
...
?>
                  <tr>
                    <td align="right" colspan="2"><?php echo '<a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES) . '">' . tep_image_button('button_reset.png', IMAGE_RESET) . '</a>'; ?></td>
                  </tr>
<?php
    } else {
?>
			      <tr>
                    <td align="right" colspan="2" class="smallText"><?php echo '<a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, 'page=' . $_GET['page'] . '&action=new') . '">' . tep_image_button('button_insert.png', IMAGE_INSERT) . '</a>'; ?></td>
                  </tr>
<?php
	}
?>
...
<?php
  ...
  switch ($_GET['action']) {
    case 'confirm':
        if ($_GET['dcID'] != '0') {
            $heading[] = array('text' => ''. tep_draw_separator('pixel_trans.gif', '11', '12') .'&nbsp;<b>' . TEXT_INFO_HEADING_DELETE_DISCOUNT_CATEGORY . '</b>');
        ...
        /*    if ($cInfo->number_of_reviews > 0) $contents[] = array('text' => '<br>' . tep_draw_checkbox_field('delete_reviews', 'on', true) . ' ' . sprintf(TEXT_DELETE_REVIEWS, $cInfo->number_of_reviews)); */
            $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image_submit('button_delete.png', IMAGE_DELETE) . ' <a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('dcID', 'action')) . 'dcID=' . $cInfo->discount_categories_id) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>');
        } else {
    ...
    default:
      if (is_object($cInfo)) {
        $heading[] = array('text' => ''. tep_draw_separator('pixel_trans.gif', '11', '12') .'&nbsp;<b>' . $cInfo->discount_categories_name . '</b>');
        $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('dcID', 'action')) . 'dcID=' . $cInfo->discount_categories_id . '&action=edit') . '">' . tep_image_button('button_edit.png', IMAGE_EDIT) . '</a> <a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('dcID', 'action')) . 'dcID=' . $cInfo->discount_categories_id . '&action=confirm') . '">' . tep_image_button('button_delete.png', IMAGE_DELETE) . '</a>');
        $contents[] = array('align' => 'center', 'text' => '<a href="' . tep_href_link(FILENAME_DISCOUNT_CATEGORIES, tep_get_all_get_params(array('dcID', 'action', 'page')) . 'dcID=' . $cInfo->discount_categories_id . '&action=show_products') . '">' . tep_image_button('button_show_products.png', IMAGE_SHOW_PRODUCTS) . '</a>');
