<?php //$Id: /catalog/admin/affiliate_contact.php (0158)
...
?>
                <table border="0" width="100%" cellpadding="0" cellspacing="2">
                  <tr>
                    ...
                    <td align="right"><?php echo '<a href="' . tep_href_link(FILENAME_AFFILIATE_CONTACT) . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a> ' . tep_image_submit('button_send_mail.png', IMAGE_SEND_EMAIL); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
