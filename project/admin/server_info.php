<?php //$Id: /catalog/admin/server_info.php (osC)
...
<?php
    ...
    echo '<table border="1" cellpadding="3" width="600" style="border: 0px; border-color: #000000;">' .
         '  <tr><td><a href="http://www.oscommerce.com"><img border="0" src="images/store_logo.png" title="' . PROJECT_VERSION . '" /></a><h1 class="p"> ' . PROJECT_VERSION . '</h1></td>' . 
         '  </tr>' .
         '</table>';
    echo $regs[1];
  } else {
