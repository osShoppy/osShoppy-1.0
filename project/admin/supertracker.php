<?php //$Id: /catalog/admin/supertracker.php (3924)
...
<?php
						...
						echo '<span class="supertracker_text">' . sprintf(TEXT_TABLE_DATABASE, $num_rows, tep_date_short($maint_row['time_arrived'])) . '</span><br><br>';
						echo '<form name="del_rows" action="supertracker.php?action=del_rows" method="post">' . TEXT_TABLE_DELETE . '<input name="num_rows" size=10>&nbsp;<input type="submit" value="' . TEXT_BUTTON_ERASE  . '"></form><br><br>';
?>
