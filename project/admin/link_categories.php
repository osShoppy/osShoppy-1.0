<?php //$Id: /catalog/admin/link_categories.php (5272)
            ...
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr class="dataTableHeadingRow">
                <td class="dataTableHeadingContent" align="left">
                  <?php echo (($listing=='title' or $listing=='title-desc') ? '<font color="FF0000"><b>' . TABLE_HEADING_LINK_CATEGORIES . '</b></font>' : '<b>'. TABLE_HEADING_LINK_CATEGORIES . '</b>'); ?>
                ...
                <td class="dataTableHeadingContent" align="center">
                  <?php echo (($listing=='status' or $listing=='status-desc') ? '<font color="FF0000"><b>' . TABLE_HEADING_STATUS . '</b></font>' : '<b>'. TABLE_HEADING_STATUS . '</b>'); ?>
...
// Get parent_id for sublink_categories if search
  ...
  ?>
                ...
                <?php
                 if ($catCount)
                   echo '<a href="' . tep_href_link(FILENAME_LINK_CATEGORIES, tep_get_path($link_categories['link_categories_id'])) . '">' . tep_image(DIR_WS_ICONS . 'file_icons/folder.gif', ICON_FOLDER) . '</a>&nbsp;<b>' . $link_categories['link_categories_name'] . '</b>&nbsp;( ' . $catCount . ' )';
                 else
                   echo '<a href="' . tep_href_link(FILENAME_LINK_CATEGORIES, tep_get_path($link_categories['link_categories_id'])) . '">' . tep_image(DIR_WS_ICONS . 'file_icons/folder.gif', ICON_FOLDER) . '</a>&nbsp;<b>' . $link_categories['link_categories_name'] . '</b>&nbsp;';
                ?>
                </td>
                ...
                if ($link_categories['link_categories_status'] == STATUS_CATEGORIES_ENABLE_FLAG) {
                  ...
                  tep_image(DIR_WS_IMAGES . 'icons/status_icons/icon_status_green_light.gif', IMAGE_ICON_STATUS_GREEN_LIGHT, 10, 10) . '</a>&nbsp;&nbsp;' .
                  tep_image(DIR_WS_IMAGES . 'icons/status_icons/icon_status_red.gif', IMAGE_ICON_STATUS_RED, 10, 10);
                }
                ?>
                </td>
                <td class="dataTableContent" align="right"><?php if (isset($cInfo) && is_object($cInfo) && ($link_categories['link_categories_id'] == $cInfo->link_categories_id) ) { echo tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_arrow_right.gif', ''); } else { echo '<a href="' . tep_href_link(FILENAME_LINK_CATEGORIES, 'cPath=' . $cPath . '&lID=' . $link_categories['link_categories_id']) . '">' . tep_image(DIR_WS_IMAGES . 'icons/info_icons/icon_info.gif', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;</td>
              </tr>
<?php
    }
