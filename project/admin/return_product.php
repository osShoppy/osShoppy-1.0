<?php //$Id: /catalog/admin/return_product.php (1136)
    ...
    switch ($HTTP_GET_VARS['action']) {
      ...
      case 'update':
         ...
         if ($HTTP_POST_VARS['returns_quantity'] > $orders_return['products_quantity']) {
             tep_redirect(tep_href_link(FILENAME_RETURN, 'qty_error=yes&order_id=' . $HTTP_GET_VARS['oID'] . '&products_id=' . $HTTP_GET_VARS['products_id']));
         }
           if (tep_validate_email($HTTP_POST_VARS['customers_email_address']) == false) {
		      tep_redirect(tep_href_link(FILENAME_RETURN, 'email_error=yes&order_id=' . $HTTP_GET_VARS['oID'] . '&products_id=' . $HTTP_GET_VARS['products_id']));
         }
           if ($HTTP_POST_VARS['contact_user_name'] == '') {
		      tep_redirect(tep_href_link(FILENAME_RETURN, 'name_error=yes&order_id=' . $HTTP_GET_VARS['oID'] . '&products_id=' . $HTTP_GET_VARS['products_id']));
         }
         ...
         $customers_email = tep_db_prepare_input($HTTP_POST_VARS['customers_email_address']);
         ...
         $contact_user_name = tep_db_prepare_input($HTTP_POST_VARS['contact_user_name']);
