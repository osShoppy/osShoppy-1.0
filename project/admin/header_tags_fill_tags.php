<?php //$Id: /catalog/admin/header_tags_fill_tags.php (5581)
  ...
  if (isset($_POST['action']))
  {
     ...
     if (isset($categories_fill))
     {
       ...
       { 
         ...
         {
           $categories_tags_query = tep_db_query("select categories_name, categories_id, categories_htc_title_tag, categories_htc_desc_tag, categories_htc_keywords_tag, language_id from  " . TABLE_CATEGORIES_DESCRIPTION . " where " . $byCatID . " language_id = '" . (int)$languages[$i]['id']. "'");
           while ($categories_tags = tep_db_fetch_array($categories_tags_query))
           {
             ...
             if ($updateDB)
             {
               if (isset($_POST['generic_enabled']) && $_POST['generic_enabled'] == 'on')
               {
                  ...
                  $set = BuildGenericString($set, $addComma, 'categories_htc_desc_tag', $categories_tags['categories_name'], $_POST['add_generic_cat_meta_desc'], $_POST['generic_cat_meta_desc']);
                  $set = BuildGenericString($set, $addComma, 'categories_htc_keywords_tag', $categories_tags['categories_name'], $_POST['add_generic_cat_keywords'], $_POST['generic_cat_keywords']);
                  $set = BuildGenericString($set, $addComma, 'categories_htc_description', $categories_tags['categories_name'], $_POST['add_generic_cat_description'], $_POST['generic_cat_description']);
               }
               ...
               if (! empty($categories_tags['categories_name']))
               {
                 if (empty($addComma))
                   ...
                   tep_db_query("update " . TABLE_CATEGORIES_DESCRIPTION . $set . " where categories_id = '" . $categories_tags['categories_id']."' and language_id  = '" . (int)$languages[$i]['id'] . "'");
     
                 $fillTagsCtr['categories']++;  
               }
               else
                 $fillTagsErrors['categories'][] = '<a class="htc_Link" href="' . tep_href_link(FILENAME_CATEGORIES, 'cID=' . $categories_tags['categories_id']) . '&action=edit_category">' . sprintf(ERROR_FILL_TAGS_CATEGORIES, $categories_tags['categories_id'],$languages[$i]['id']) . '</a>';
             }           
           }
         }
         ...
         if (HEADER_TAGS_ENABLE_CACHE == 'true') {  
            ResetCache_HeaderTags('index.php', '_id_c_', true);
         }                       
       }
     }
     else
     ...
     if (isset($manufacturers_fill))
     {
       ...
       { 
           ...
           while ($manufacturers_tags = tep_db_fetch_array($manufacturers_tags_query))
           {
             ...
             {          
               if (isset($_POST['generic_enabled']) && $_POST['generic_enabled'] == 'on')
               {
                  ...
                  $set = BuildGenericString($set, $addComma, 'manufacturers_htc_title_tag', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_title'], $_POST['generic_man_title']);
                  $set = BuildGenericString($set, $addComma, 'manufacturers_htc_desc_tag', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_meta_desc'], $_POST['generic_man_meta_desc']);
                  $set = BuildGenericString($set, $addComma, 'manufacturers_htc_keywords_tag', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_keywords'], $_POST['generic_man_keywords']);
                  $set = BuildGenericString($set, $addComma, 'manufacturers_htc_description', $manufacturers_tags['manufacturers_name'], $_POST['add_generic_man_description'], $_POST['generic_man_description']);
               }
               ...
               { 
                 if (empty($addComma))
                   ...
                   tep_db_query("update " . TABLE_MANUFACTURERS_INFO . $set . " where manufacturers_id = '" . $manufacturers_tags['manufacturers_id']."' and languages_id  = '" . (int)$languages[$i]['id'] . "'");
   
                 $fillTagsCtr['manufacturers']++;  
               }
               else
                 $fillTagsErrors['manufacturers'][] = '<a class="htc_Link" href="' . tep_href_link(FILENAME_MANUFACTURERS, 'mID=' . $manufacturers_tags['manufacturers_id']) . '&action=edit_category">' . sprintf(ERROR_FILL_TAGS_MANUFACTURERS, $manufacturers_tags['manufacturers_id'],$languages[$i]['id']) . '</a>';
             }
           }
         }
         ...
         if (HEADER_TAGS_ENABLE_CACHE == 'true') {  
            ResetCache_HeaderTags('index.php', '_id_m_', true);
         }                                
       }
     }
     else
     ...
     if (isset($products_fill))
     {
       ...
       { 
           ...
           while ($products_tags = tep_db_fetch_array($products_tags_query))
           {
             ...
             if ($updateDB)
             {
               ...
               else if (isset($_POST['generic_enabled']) && $_POST['generic_enabled'] == 'on')
               {
                  ...
                  $set = BuildGenericString($set, $addComma, 'products_head_title_tag', $products_tags['products_name'], $_POST['add_generic_prod_title'], $_POST['generic_prod_title']);
                  $set = BuildGenericString($set, $addComma, 'products_head_desc_tag', $products_tags['products_name'], $_POST['add_generic_prod_meta_desc'], $_POST['generic_prod_meta_desc']);
                  $set = BuildGenericString($set, $addComma, 'products_head_keywords_tag', $products_tags['products_name'], $_POST['add_generic_prod_keywords'], $_POST['generic_prod_keywords']);
               }
               else
               {        
                 $desc = $products_tags['products_name'];           
               ...
               {            
                 if (empty($addComma))
                   ...
                   tep_db_query("update " . TABLE_PRODUCTS_DESCRIPTION . $set . " where products_id = '" . $products_tags['products_id'] . "' and language_id='". (int)$languages[$i]['id'] ."'");
         ...
         if (HEADER_TAGS_ENABLE_CACHE == 'true') {  
            ResetCache_HeaderTags('product_info.php', '_id_p_', true);
         }              
       }
     }
     else
    ...
    <td width="100%" valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
     ...
     <tr>
      <td align="right"><?php echo tep_draw_form('header_tags', FILENAME_HEADER_TAGS_FILL_TAGS, '', 'post') . tep_draw_hidden_field('action', 'process'); ?></td>
       ...
       <tr>
        <td><table border="1" class="HTC_Box">
         <tr> 
          <td colspan="3" class="HTC_title"><?php echo HEADING_TITLE_FILL_TAGS_OVERRIDES; ?></td>
         </tr> 
         <tr>
          <td width="55%"><table border="0" width="100%">    
           <tr><td class="main" align="center" style="font-weight: bold; background-color: #FAF8CC"><?php echo TEXT_OVERRIDE_DESCRIPTION; ?></td></tr>    
           <tr class="main"> 
           ...
           <tr><td class="main" align="center" style="font-weight: bold; background-color: #FAF8CC"><?php echo TEXT_OVERRIDE_KEYWORDS; ?></td></tr>               
           <tr class="main"> 
           ...
           <tr><td class="main" align="center" style="font-weight: bold; background-color: #FAF8CC"><?php echo TEXT_OVERRIDE_GENERIC; ?></td></tr>               
           <tr class="main"> 
          ...
          <td width="55%"><table border="0" width="100%">
           <tr>
            <td><table border="0" width="100%">
             ...
             <tr class="smallText">          
              <td align=left title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group1" VALUE="none" <?php echo (isset($checkedCats['none']) ? $checkedCats['none'] : ''); ?>> <?php echo HEADING_TITLE_SEO_SKIPALL; ?></td>
              <td align=left title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group2" VALUE="none" <?php echo (isset($checkedManuf['none']) ? $checkedManuf['none'] : ''); ?>> <?php echo HEADING_TITLE_SEO_SKIPALL; ?></td>
              <td align=left title="<?php echo $filltagsPopup['skipall']; ?>" class="popup"><INPUT TYPE="radio" NAME="group3" VALUE="none" <?php echo (isset($checkedProds['none']) ? $checkedProds['none'] : ''); ?>> <?php echo HEADING_TITLE_SEO_SKIPALL; ?></td>
             </tr>
             <tr class="smallText"> 
              <td align=left title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="empty" <?php echo (isset($checkedCats['empty']) ? $checkedCats['empty'] : ''); ?> > <?php echo HEADING_TITLE_SEO_FILLONLY; ?></td>
              <td align=left title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="empty" <?php echo (isset($checkedManuf['empty']) ? $checkedManuf['empty'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLONLY; ?></td>
              <td align=left title="<?php echo $filltagsPopup['empty']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="empty" <?php echo (isset($checkedProds['empty']) ? $checkedProds['empty'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLONLY; ?></td>
             </tr>
             <tr class="smallText"> 
              <td align=left title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="full" <?php echo (isset($checkedCats['full']) ? $checkedCats['full'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLALL; ?></td>
              <td align=left title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="full" <?php echo (isset($checkedManuf['full']) ? $checkedManuf['full'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLALL; ?></td>
              <td align=left title="<?php echo $filltagsPopup['full']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="full" <?php echo (isset($checkedProds['full']) ? $checkedProds['full'] : ''); ?>> <?php echo HEADING_TITLE_SEO_FILLALL; ?></td>
             </tr>
             <tr class="smallText"> 
              <td align=left title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group1" VALUE="clear" <?php echo (isset($checkedCats['clear']) ? $checkedCats['clear'] : ''); ?>> <?php echo HEADING_TITLE_SEO_CLEARALL; ?></td>
              <td align=left title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group2" VALUE="clear" <?php echo (isset($checkedManuf['clear']) ? $checkedManuf['clear'] : ''); ?>> <?php echo HEADING_TITLE_SEO_CLEARALL; ?></td>
              <td align=left title="<?php echo $filltagsPopup['clear']; ?>"><INPUT TYPE="radio" NAME="group3" VALUE="clear" <?php echo (isset($checkedProds['clear']) ? $checkedProds['clear'] : ''); ?>> <?php echo HEADING_TITLE_SEO_CLEARALL; ?></td>
             </tr>
            </table></td>         
           </tr> 
           <tr>
           ...
           <tr>
            <td><table border="0" width="100%">
             ...
             <?php if (tep_not_null($updateTextCat)) { ?>
              <tr>
               <td class="HTC_subHead"><?php echo sprintf($updateTextCat, $fillTagsCtr['categories']); ?></td>
              </tr> 
              ...
              <tr>
               <td class="HTC_subHead"><?php echo sprintf($updateTextManuf, $fillTagsCtr['manufacturers']); ?></td>
              </tr>
             ...
             <?php } 
              ...
              <tr>
               <td class="HTC_subHead"><?php echo sprintf($updateTextProd, $fillTagsCtr['products']); ?></td>
              </tr>
