<?php //$Id: /catalog/admin/faq_form.php (1948) ?>
...
<td align="right">
<?php
  echo tep_image_submit('button_save.png', IMAGE_SAVE);
  echo '&nbsp;<a href="' . tep_href_link(FILENAME_FAQ_MANAGER, '', 'NONSSL') . '">' . tep_image_button('button_cancel.png', IMAGE_CANCEL) . '</a>';
?>
</td>
</tr>
</table>
