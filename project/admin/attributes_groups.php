<?php //$Id: /catalog/admin/attributes_groups.php (0716)
...
<link rel="stylesheet" type="text/css" href="templates/<?php echo DIR_WS_TEMPLATES_DEFAULT; ?>/stylesheet.css">
</head>
...
<?php echo '<p style="margin-top: 20px;">' . tep_image_submit('button_save.png', IMAGE_SAVE, 'name="submitbutton"') . '&#160;' . tep_image_button('button_cancel.png', IMAGE_CANCEL, 'onclick=\'self.close()\'') .'</p>' . "\n";
?>
</form>
</div>
<?php
...
echo '<div align="center" style="margin-top: 50px;">' . "\n" . '<form name="close">' . "\n" . tep_image_button('button_cancel.png', IMAGE_CLOSE, 'onclick=\'self.close()\'') .'</form>' . "\n" . '</div>' . "\n";
}
?>
</body>
</html>
