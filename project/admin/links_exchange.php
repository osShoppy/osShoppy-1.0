<?php //$Id: /catalog/admin/link_exchange.php (5272)
  ...
  if (isset($_POST['links_exchange_x']))
  {
    ...
    for ($i=0, $n=sizeof($languages); $i<$n; $i++) 
    {
      ...
      if ($links['total'] > 0) 
        tep_db_query("update " . TABLE_LINKS_EXCHANGE . " set links_exchange_name = '" . tep_db_input($links_exchange_name) . "', links_exchange_description = '" . tep_db_input($links_exchange_description) . "', links_exchange_url = '" . tep_db_input($links_exchange_url) . "' where language_id = '" . (int)$languages[$i]['id'] . "'");
      else
        tep_db_query("insert into " . TABLE_LINKS_EXCHANGE . " (links_exchange_name, links_exchange_description, links_exchange_url, language_id) values ('" . tep_db_input($links_exchange_name) . "', '" . tep_db_input($links_exchange_description) . "', '" . tep_db_input($links_exchange_url) . "', '" . (int)$languages[$i]['id'] . "')");
    }
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2" class="linksBordered">
          <tr>
            <td class="linksHead"><?php echo HEADING_TITLE_LINKS_EXCHANGE; ?></td>
