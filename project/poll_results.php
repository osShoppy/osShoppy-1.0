<?php //$Id: /catalog/poll_results.php (0020) ?>
<tr><td>
<table align="center">
<?PHP
...
$percent2 = (int)$percent;
 if ($percent > 0) {
?>
<img src="images/polls/leftbar.gif" height="15" width="7" Alt="<?echo $percent2?> %"><img src="images/polls/mainbar.gif" height="15" width="<?echo $percentInt?>" Alt="<?echo $percent2?> %"><img src="images/polls/rightbar.gif" height="15" width="7" Alt="<?echo $percent2?> %">

<?php
  } else {
?>
<img src="images/polls/leftbar.gif" height="15" width="7" Alt="<? echo $percent2?> %"><img src="images/polls/mainbar.gif" height="15" width="3" Alt="<? echo $percent2?> %"><img src="images/polls/rightbar.gif" height="15" width="7" Alt="<? echo $percent2?> %">
