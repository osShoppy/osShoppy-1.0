<?php //$Id: /catalog/shipping.php (osC)
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_ACCOUNT_COUPONS);

  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_ACCOUNT_COUPONS));
  ?><head><title><?php echo TITLE; ?></title></head>
<?php
  $content = CONTENT_ACCOUNT_COUPONS;
